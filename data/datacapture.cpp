...
gcc -std=c++11 datacapture.cpp -o picture_grabber -L/usr/lib -lstdc++ -lopencv_core -lopencv_highgui -lopencv_videoio -lopencv_imgproc -lopencv_imgcodecs
...
int main() {
	...
	while (1) {
		...
		// Press the esc key to take picture or hold it down to really take a lot! (ascii 27 is escape)
